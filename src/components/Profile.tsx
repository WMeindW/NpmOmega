        ...
        const form = <form action={"/edit?" + data.split("&")[0]} method="post">
            ...
            <div className="info-container">
                <div className="info-section">
                    ...
                    <input className="info-section-text bg-dark text-light" name="username" value={data.split("&")[1]}
                           type="text"/>
                </div>
                <div className="info-section">
                    <p className="info-section-heading bg-dark text-light">Password</p>
                    <input className="info-section-text bg-dark text-light" name="password" value={data.split("&")[2]}
                           type="text"/>
                </div>
                <div className="info-section">
